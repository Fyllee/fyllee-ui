...
// Assets and style
import { Twitter, Instagram, Facebook, Email } from '../assets/global/networks/index';
...
export default function Footer(): ReactElement {
	const networks: [any, string][] = [[Twitter, 'https://twitter.com/bild'], [Instagram, 'https://instagram.com/bild'], [Facebook,  'https://facebook.com/bild'], [Email, 'mailto:contact@bild.com']];
	const links: ILinks = {
		'Product': [
			['Overview', '/overview'],
			['Pricing', '/pricing'],
